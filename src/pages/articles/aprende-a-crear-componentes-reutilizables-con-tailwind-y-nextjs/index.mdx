...
export const meta = {
  ...
  slug: 'aprende-a-crear-componentes-reutilizables-con-tailwind-y-nextjs',
  tags: ['Desarrollo'],
  keywords:
    'componentes reutilizables Tailwind Next.js, botón reutilizable, imagen de perfil reutilizable , personalización con Tailwind',
  description:
    'Aprende cómo crear componentes reutilizables de alta calidad utilizando Tailwind y Next.js para tu aplicación web. A través de los ejemplos de botón y imagen de perfil, veremos cómo crear componentes reutilizables con estas herramientas y cómo personalizarlos para satisfacer tus necesidades.'
};
