        ...
        <div className="pt-10 pb-16 border-t border-zinc-900/10 dark:border-white/10">
          <Container.Inner>
            <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
              <div className="flex flex-wrap justify-center gap-6 text-sm font-medium md:justify-start text-zinc-600 dark:text-zinc-400 ">
                <NavLink href="/about">About</NavLink>
                <NavLink href="/articles">Blog</NavLink>
                <NavLink href="/proyectos">Proyectos</NavLink>
                <NavLink href="/recomendaciones">Recomendaciones</NavLink>
                <NavLink href="https://shop.educalvolopez.com" target="_blank" rel="noopener noreferrer">Tienda</NavLink>
