...
export function Footer() {
  return (
    <motion.footer className="mt-32" {...FADE_IN_ANIMATION_CARD}>
      <Container.Outer>
        <div className="border-t border-zinc-900/10 pt-10 pb-16 dark:border-white/10">
          <Container.Inner>
            <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
              ...
              <span className="pointer-events-auto ml-2 inline-flex items-center rounded-md border border-zinc-200 bg-white/10 px-2 py-0 text-xs font-semibold text-zinc-900 backdrop-blur-sm dark:border-white/10 dark:bg-zinc-900/20 dark:text-zinc-100 dark:backdrop-blur sm:hidden">
