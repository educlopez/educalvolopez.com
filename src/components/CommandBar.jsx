    ...
    >
      <Dialog as="div" className="relative z-[90]" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 p-4 overflow-y-auto sm:p-6 md:p-20">
          ...
          >
            <Dialog.Panel className="max-w-2xl p-6 mx-auto overflow-hidden transition-all transform divide-y shadow-2xl divide-zinc-700 divide-opacity-10 rounded-xl border-black/10 bg-white/80 ring-1 ring-black ring-opacity-5 backdrop-blur-sm backdrop-filter dark:divide-zinc-700 dark:border-white/10 dark:bg-zinc-900/80 dark:backdrop-blur">
              <Combobox onChange={(item) => (window.location = item.url)}>
                {/*  <div className="relative">
                  <MagnifyingGlassIcon
                    className="pointer-events-none absolute top-3.5 left-4 h-5 w-5 text-neutral-700 dark:text-white"
                    aria-hidden="true"
                  />
                  <Combobox.Input
                ...
                {(query === '' || filteredProjects.length > 0) && (
                  ...
                  >
                    {/*<li className="p-2">
                      {query === '' && (
                        <h2 className="px-3 mt-4 mb-2 text-xs font-semibold text-neutral-700 dark:text-white">
                          Busquedas recientes
                        </h2>
                      )}
                      <ul className="text-sm text-neutral-700 dark:text-white">
                ...
                {/* {query !== '' && filteredProjects.length === 0 && (
                  <div className="px-6 text-center py-14 sm:px-14">
                    <FolderIcon
                      className="w-6 h-6 mx-auto text-neutral-700 dark:text-white"
                      aria-hidden="true"
                    />
                    <p className="mt-4 text-sm text-neutral-700 dark:text-white">
                      Sin proyectos.
                    </p>
                  </div>
               )}*/}
