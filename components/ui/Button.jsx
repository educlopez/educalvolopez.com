...
const buttonVariants = cva('object-cover', {
  variants: {
    styleBtn: {
      primary:
...
export function Button({ styleBtn, className, href, ...props }) {
  className = cn(
    ...
    'inline-flex items-center gap-2 justify-center overflow-hidden rounded-md text-sm outline-offset-2 transition active:transition-none',
    className
  )
