...
const variantStyles = {
  ...
  secondary:
    'bg-white/10 dark:bg-zinc-900/20 font-medium text-neutral-900 hover:bg-zinc-100 active:bg-zinc-100 active:text-neutral-900/60 dark:text-zinc-300 border border-black/10 dark:border-white/10 dark:hover:bg-zinc-900 dark:hover:text-neutral-50 dark:active:bg-zinc-900/50 dark:active:text-zinc-50/70',
  solid:
