...
function MobileNavItem({ href, children, target, rel }: NavLinkProps) {
  return (
    <li>
      <Popover.Button
        as={Link}
...
function MobileNavigation(props: DisNavProps) {
  return (
    <Popover {...props}>
...
function DesktopNavigation(props: DisNavProps) {
...
function Avatar({ large = false, className, index, ...props }: AvatarProps) {
